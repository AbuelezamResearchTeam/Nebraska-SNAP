...
# purpose: script reads in HHP data, aggregates and writes two dfs
...
# a list of raw files for weights and data in:
...
# source: https://www2.census.gov/programs-surveys/demo/datasets/hhp
# output: here("trunk","derived","Gold Files","Household Pulse Survey Data Tables","hhp_final.txt")
```
